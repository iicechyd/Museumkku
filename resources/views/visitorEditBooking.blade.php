            ...
            <form method="POST" action="{{ route('bookings.update', $booking->booking_id) }}"  class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('instituteName') is-invalid @enderror"
                        ...
                        value="{{ old('instituteName', $institutes->instituteName ?? $booking->instituteName) }}" required>
                    @error('instituteName')
                        <div class="my-2">
                            <span class="text-danger">{{ $message }}</span>
                        </div>
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control @error('subdistrict') is-invalid @enderror"
                        ...
                        value="{{ old('subdistrict', $institutes->subdistrict ?? $booking->subdistrict) }}" disabled
                        required>
                    @error('subdistrict')
                        <div class="my-2">
                            <span class="text-danger">{{ $message }}</span>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error('district') is-invalid @enderror" id="district"
                        name="district" value="{{ old('district', $institutes->district ?? $booking->district) }}"
                        disabled required>
                    @error('district')
                        <div class="my-2">
                            <span class="text-danger">{{ $message }}</span>
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control @error('province') is-invalid @enderror" id="province"
                        name="province" value="{{ old('province', $institutes->province ?? $booking->province) }}"
                        disabled required>
                    @error('inputProvince')
                        <div class="my-2">
                            <span class="text-danger">{{ $message }}</span>
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control mt-2" id="monkInput" name="monk_qty" min="0"
                            value="{{ $booking->monk_qty > 0 ? $booking->monk_qty : '' }}"
